...
class Enqueue
{
    ...
    {
        wp_register_script('data-sync-admin', DATA_SYNC_URL . 'public/assets/dist/js/admin-autoloader.es6.js', array( 'jquery' ), 1, true);
    ...
    public function admin_styles()
    {
        ...
        wp_register_style('data-sync-admin', DATA_SYNC_URL . 'public/assets/dist/styles/data-sync.css', false, 1);
