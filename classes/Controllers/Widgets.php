...
class Widgets {
	...
	public function dashboard() {
		...
		wp_add_dashboard_widget( 'wp_data_sync_enabled_post_types_dashboard', __( 'WP Data Sync - Push-Enabled Post Types', 'data_sync' ), 'DataSync\enabled_post_types_widget' );
	}
}